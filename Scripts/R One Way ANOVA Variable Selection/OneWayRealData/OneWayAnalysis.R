OneWayAnalysis <- function(startList,dataList)
{
  ...
  outList = list(postProb,orderedPostProbIndex,topPostProbIndex,SSBM,SSBV,SSSigM,SSSigV,SSSigAllM,SSSigAllV,SSBallM,SSBallV,SSBGrandM,SSBGrandV,SSANOVASigM,SSANOVASigV)#,probDiffMat,probSameMat)
  return(outList)
